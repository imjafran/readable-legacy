...
?>
				...
				<label for="service1"><input class="checkbox" id="service1" name="service1" type="checkbox"   
				<?php
				if ( $options['service1'] ) {
					echo ' checked="checked"';}
				?>
				 > <img src="<? bloginfo("wpurl"); ?>/wp-content/plugins/readable/images/google.gif" /></label><br/><br/>
				
				
				<label for="service2"><input class="checkbox" id="service2" name="service2" type="checkbox"   
				<?php
				if ( $options['service2'] ) {
					echo ' checked="checked"';}
				?>
				 > <img src="<? bloginfo("wpurl"); ?>/wp-content/plugins/readable/images/ngsub1.gif" /></label><br/><br/>
				
				
			   <label for="service3"><input class="checkbox" id="service3" name="service3" type="checkbox"   
			   <?php
				if ( $options['service3'] ) {
					echo ' checked="checked"';}
				?>
				 > <img src="<? bloginfo("wpurl"); ?>/wp-content/plugins/readable/images/bloglines.gif" /></label><br/><br/>
				
				
				<label for="service4"><input class="checkbox" id="service4" name="service4" type="checkbox"   
				<?php
				if ( $options['service4'] ) {
					echo ' checked="checked"';}
				?>
				 > <img src="<? bloginfo("wpurl"); ?>/wp-content/plugins/readable/images/yahoo.gif" /></label><br/><br/>
				
				
				 <label for="service5"><input class="checkbox" id="service5" name="service5" type="checkbox"   
				 <?php
					if ( $options['service5'] ) {
						echo ' checked="checked"';}
					?>
					 > <img src="<? bloginfo("wpurl"); ?>/wp-content/plugins/readable/images/myaol.gif" /></label><br/><br/>
				  
				  
				  <label for="service6"><input class="checkbox" id="service6" name="service6" type="checkbox"   
				  <?php
					if ( $options['service6'] ) {
						echo ' checked="checked"';}
					?>
					 > <img src="<? bloginfo("wpurl"); ?>/wp-content/plugins/readable/images/netvibes.gif" /></label><br/><br/>
				   
				   
				  <label for="service7"><input class="checkbox" id="service7" name="service7" type="checkbox"   
				  <?php
					if ( $options['service7'] ) {
						echo ' checked="checked"';}
					?>
					 > <img src="<? bloginfo("wpurl"); ?>/wp-content/plugins/readable/images/pageflakes.gif" /></label>
